...
const Footer = () => {
  return (
    <footer className="text-center text-lg-start colornav text-muted">
        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="http://localhost:3000/prenota" className="text-reset">
                  Prenota
                </a>
              </p>
            </div>
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="http://localhost:3000/ordered" className="text-reset">
                  Orders
                </a>
              </p>
              <p>
